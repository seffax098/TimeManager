    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.AlterDatabase()
                .Annotation("Npgsql:Enum:activity_source_type", "browser,desktop_app,window,system")
                .Annotation("Npgsql:Enum:activity_verdict", "work,rest,unknown")
                .Annotation("Npgsql:Enum:report_status_color", "green,yellow,red")
                .Annotation("Npgsql:Enum:session_status", "active,paused,completed")
                .Annotation("Npgsql:Enum:user_role", "employee,admin");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("chk_users_settings_has_work_time", "settings ? 'work_time'");
                    table.CheckConstraint("chk_users_settings_theme", "(settings->>'theme') in ('light', 'dark')");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    status_color = table.Column<ReportStatusColor>(type: "report_status_color", nullable: false),
                    created_at = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_daily_reports", x => x.report_id);
                    table.CheckConstraint("chk_daily_reports_total", "(work_percent = 0 and rest_percent = 0) or abs((work_percent + rest_percent) - 100) <= 0.01");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("chk_refresh_tokens_dates", "expires_at > created_at");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("chk_work_sessions_time", "ended_at is null or ended_at >= started_at");
                    table.CheckConstraint("chk_work_sessions_totals", "total_seconds >= work_time + rest_time");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    session_id = table.Column<Guid>(type: "uuid", nullable: false),
                    source_type = table.Column<ActivitySourceType>(type: "activity_source_type", nullable: false),
                    ...
                    verdict = table.Column<ActivityVerdict>(type: "activity_verdict", nullable: false),
                    created_at = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_activity_records", x => x.activity_id);
                    table.CheckConstraint("chk_activity_records_time", "ended_at >= started_at");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "idx_activity_records_domain",
                table: "activity_records",
                column: "domain");

            migrationBuilder.CreateIndex(
                name: "idx_activity_records_session_id",
                table: "activity_records",
                column: "session_id");

            migrationBuilder.CreateIndex(
                name: "idx_activity_records_session_started_at",
                table: "activity_records",
                columns: new[] { "session_id", "started_at" });

            migrationBuilder.CreateIndex(
                name: "idx_activity_records_source_type",
                table: "activity_records",
                column: "source_type");

            migrationBuilder.CreateIndex(
                name: "idx_activity_records_started_at",
                table: "activity_records",
                column: "started_at");

            migrationBuilder.CreateIndex(
                name: "idx_activity_records_verdict",
                table: "activity_records",
                column: "verdict");

            migrationBuilder.CreateIndex(
                name: "idx_daily_reports_report_date",
                table: "daily_reports",
                column: "report_date");
            ...
            migrationBuilder.CreateIndex(
                name: "uq_daily_reports_user_date",
                table: "daily_reports",
            ...
            migrationBuilder.CreateIndex(
                name: "idx_tech_stack_items_user_id",
                table: "tech_stack_items",
                column: "user_id");

            migrationBuilder.CreateIndex(
                name: "uq_tech_stack_user_name",
                table: "tech_stack_items",
                columns: new[] { "user_id", "name" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "uq_tech_stack_user_position",
                table: "tech_stack_items",
            ...
            migrationBuilder.CreateIndex(
                name: "idx_violations_created_at",
                table: "violations",
                column: "created_at");
            ...
            migrationBuilder.CreateIndex(
                name: "idx_work_sessions_status",
                table: "work_sessions",
                column: "status");

            migrationBuilder.CreateIndex(
                name: "idx_work_sessions_user_date",
                table: "work_sessions",
                columns: new[] { "user_id", "work_date" });

            migrationBuilder.CreateIndex(
                name: "uq_work_sessions_one_open_per_user",
                table: "work_sessions",
                column: "user_id",
                unique: true,
